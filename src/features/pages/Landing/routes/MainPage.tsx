...
const MainPage = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-20 mt-10 mx-auto w-fit">
      ...
      <div className="bg-muted/50 mx-auto flex md:flex-row flex-col gap-4 justify-center md:justify-between items-center h-fit p-4 rounded-md max-w-screen-lg w-full">
